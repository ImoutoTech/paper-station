...
### Package: @paper-station/backend (`spec/backend/`)

- Backend guidelines: `.trellis/spec/backend/backend/`

- Frontend guidelines: `.trellis/spec/backend/frontend/`

### Package: @paper-station/finder (`spec/finder/`)

- Backend guidelines: `.trellis/spec/finder/backend/`

- Frontend guidelines: `.trellis/spec/finder/frontend/`

### Package: @paper-station/frontend (`spec/frontend/`)
